...
if __name__ == '__main__':
    ...
    # Vectorazition of train matrix (15 elements with 32x32) to (15 rows and 32x32 cols)
    nums_samples, width, height = X.shape
    X_vector = X.reshape(nums_samples, width * height)
    # print(X_vector.shape) # (15, 1024)

    # Vectorazition of test matrix (4 elements with 32x32) to (4 rows and 32x32 cols)
